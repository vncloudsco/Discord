namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    internal class ZipOutputStream : DeflaterOutputStream
    {
        ...
        public void CloseEntry()
        {
            ...
            {
                object[] objArray1 = new object[] { "size was ", this.size, ", but I expected ", this.curEntry.Size };
            ...
            {
                object[] objArray2 = new object[] { "compressed size was ", size, ", but I expected ", this.curEntry.CompressedSize };
                throw new ZipException(string.Concat(objArray2));
            }
            ...
            {
                object[] objArray3 = new object[] { "crc was ", this.crc.Value, ", but I expected ", this.curEntry.Crc };
                throw new ZipException(string.Concat(objArray3));
            }
            this.offset += size;
            if (this.curEntry.IsCrypted)
            {
                this.curEntry.CompressedSize = (this.curEntry.AESKeySize <= 0) ? (this.curEntry.CompressedSize + 12) : (this.curEntry.CompressedSize + this.curEntry.AESOverheadSize);
            }
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            this.size += count;
            CompressionMethod curMethod = this.curMethod;
        ...
        public bool IsFinished =>
            ReferenceEquals(this.entries, null);
